...
describe('Component: UiGrid', () => {
    ...
    class TestFixtureGridWithGroupComponent {
        ...
        public grid!: UiGridComponent<ITestEntity>;
        public groupMessageCb?: Function;
        public data: ITestEntity[] = [];
    ...
    describe('Scenario: groupable grid', () => {
        ...
        describe('Configuration: with group', () => {
            ...
            it('should show grouped column name when grouping is done with groupMessageCb', () => {
                component.groupMessageCb = function (arg: number) {
                    if (arg > 35000) {
                        return 'Large Value';
                    }
                    return 'Small Value';
